from xml_functions import get_shots
...
def test_get_shots():
    xml_str = """
        <shoton>
            ...
            <value>
                ...
                <event_incident_typefk>154</event_incident_typefk>
                <elapsed>7</elapsed>
            ...
            <value>
                ...
                <event_incident_typefk>149</event_incident_typefk>
                <elapsed>58</elapsed>
                <subtype>distance</subtype>
                <player1>24157</player1>
                <sortorder>0</sortorder>
    ...
    """
    team_id = 10260
    shots = get_shots(team_id, xml_str)
    assert shots == 11
